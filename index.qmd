...
author: "Labaly TOURE"
institute: "Enseignant-Chercheur - Chercheur associé PRODIG"
editor: visual
...
-   Responsable de la filière Géomatique (Licence et bientot le **Master**)

-   **Thématiques**: Télédétection, Géomatique, SIG, Dynamiques foncières, R pour le spatial, Dynamiques des agro industries

-  **Terrains**: Vallée du fleuve Sénégal, Bassin arachidier, Moyenne Casamance, Ferlo
...
-   Analyser la typologie et les modes de resolutions des conflits fonciers dans la vallée du fleuve Sénégal et la région du Sine Saloum.
-   Étudier la dynamique spatio temporelle de l'occupation et de l'usage des terres

### Resultats

![Acteurs gestion fonciere](images/foncier1.png) 
![Modes d\'accés au foncier](images/foncier%202.jpg) ![Modes d\'accés au foncier](images/foncier%204.jpg)
![Conflits fonciers](images/conflits2.png)
...
Dynamique spatio-temporelle et  formes de valorisation du typha dans le delta du fleuve Sénégal

Typha : de la plante mal aimée à la ressource prisée.
Suivi des biomasses de typha disponibles 

### Contexte

Le typha, macrophyte aquatique à prolifération rapide est une plante locale qui se développe sur les berges du fleuve Sénégal. Sa prolifération rapide par le concours de plusieurs circonstances a des impacts sur l'environnement et sur l'agriculture et la pêche. Afin de réduire les effets indésirables de la présence du typha, de plus en plus, il est considéré comme une ressource du fait des nombreuses potentialités qu'il offre. En effet, l'utilisation de produits dérivés du typha par les populations est une alternative aux autres sources d'énergies.

### Methodologie

L'utilisation des images satellitaires Sentinel a permis de faire une analyse des différentes unités d'occupation du sol. 5 898 ha sont occupés par le typha dans la zone de Rosso. Le découpage de la zone d'étude en trois sous-zones (Nord-Est, Est et Ouest) a permis d'avoir un aperçu sur les espaces à forte concentration de typha.
...
- Accidents de la route - Emmanuel Bonnet, Robin, Laetitia

- MOOC Geomatique et Santé 

- Projet de recherche sur la gouvernance fonciere(USSEIN-GIZ)
...
-Labaly Toure, Olivier Ruë, Luc Descroix, Yasmin Bouaita, S. Niang, et al.. Des cartes et des atlas comme outils de gouvernance : une application aux zones littorales d'Afrique de l'Ouest. Sciences participatives, gouvernance des patrimoines et territoires des deltas : actes du colloque international du Laboratoire Mixte International "Patrimoines et Territoires de l'Eau" du 11 au 14 mai 2016 à l'Université Gaston Berger de Saint-Louis du Sénégal, L'Harmattan, pp.227-240, 2017. ⟨ird-01555891⟩
